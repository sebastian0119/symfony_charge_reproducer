 ...
 */
final class Version20200613180500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("
            INSERT INTO `cr_province` (`id`, `name`) VALUES
            (1,	'San José'),
            (2,	'Alajuela'),
            (3,	'Cartago'),
            (4,	'Heredia'),
        ...
        ");
        $this->addSql("
            INSERT INTO `cr_canton` (`id`, `province_id`, `name`) VALUES
            (101,	1,	'San José'),
            (102,	1,	'Escazú'),
            (103,	1,	'Desamparados'),
            (104,	1,	'Puriscal'),
        ...
        ");
        $this->addSql("
            INSERT INTO `cr_district` (`id`, `canton_id`, `name`) VALUES
            (10101,	101,	'Carmen'),
            (10102,	101,	'Merced'),
            (10103,	101,	'Hospital'),
            (10104,	101,	'Catedral'),
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('TRUNCATE TABLE cr_province');
        $this->addSql('TRUNCATE TABLE cr_canton');
        $this->addSql('TRUNCATE TABLE cr_district');
